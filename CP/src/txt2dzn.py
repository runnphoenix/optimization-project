...
def sort_key(line):
	# sort array according to the product of elements
	return line[0] * line[1]
	
	# sort array according to the height of each rectangle
	# return line[1]
...
def read_file(file_name):
	...
	# reverse original dimensions (widest rectangles first)
	ws = ws[::-1]
	hs = hs[::-1]
